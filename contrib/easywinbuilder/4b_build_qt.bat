...
@set QMPS=BOOST_INCLUDE_PATH=%EWBLIBS%/%BOOST%^
 ...
 OPENSSL_INCLUDE_PATH=C:\Users\Mike\Desktop\ROC-Master-master\ByTheGraceOfGodAndOrion\ROC-Master-master\libs\openssl-1.0.1e\include^
 OPENSSL_LIB_PATH=C:\Users\Mike\Desktop\ROC-Master-master\ByTheGraceOfGodAndOrion\ROC-Master-master\libs\openssl-1.0.1e^
...
@%QTPATH%\qmake.exe USE_UPNP=- %QMPS%
@echo.
@echo.
