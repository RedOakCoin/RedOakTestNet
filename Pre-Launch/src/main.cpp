...
static const int64 nDiffChangeTarget = 17280;
static const int64 patchBlockRewardDuration = 1;

int64 GetROCSubsidy(int nHeight) {
    // Tribute to 'RealSolid' & his code's structure
    int64 qSubsidy = 115.0 * COIN;
    int blocks = nHeight - nDiffChangeTarget;
    int weeks = (blocks / patchBlockRewardDuration)+1;
    //for block that has passed, decrease reward by calculated amount 0.00016%...
    for(int i = 0; i < weeks; i++)  qSubsidy -= (qSubsidy * 0.00000164847);  
    return qSubsidy;
    // Special thanks to P.B. for working out a truly unique and stable Decay Function
    // ...and also for teaching me that Guess&Check will take 48 hours to do what Log's can do in drastically less time.
...
int64 static GetBlockValue(int nHeight, int64 nFees) {
    ...
    if(nHeight < nDiffChangeTarget) {
        ...
        //patch takes effect after 17280 blocks solved
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe08bb8fd3c3f0505503641e4869fdef91d057e6d386e3d092bf3aaaf1b5494d1");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //
      //
    //March 23rd Genesis --TestNet
//block.nTime = 1395613187 
//block.GetHash = e08bb8fd3c3f0505503641e4869fdef91d057e6d386e3d092bf3aaaf1b5494d1
//CBlock(hash=e08bb8fd3c3f05055036, PoW=000001e16b6d78df3eb9, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=2a8612126e, nTime=1395613187, nBits=1e0ffff0, nNonce=389608997, vtx=1)
