...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "redoakcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    //"redoakcoin.com", "dnsseed.redoakcoin.com"},
    //{"redoakcoin.net", "dnsseed.redoakcoin.net"},
    //{"redoakcoin.biz", "dnsseed.redoakcoin.biz"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. redoakcoin is probably already running."), addrBind.ToString().c_str());
        else
